...
const TOP_LEVEL_HELP =
	"Usage:\n  omo-grok-ulw-loop <subcommand> [args]\n  omo-grok-ulw-loop hook user-prompt-submit\n  omo-grok-ulw-loop hook pre-tool-use\n  omo-grok-ulw-loop help | --help | -h\n\nDefault --goal-runtime is grok. Run `omo-grok-ulw-loop help` for subcommands.\n";

...
export async function recordFinalReviewBlockers(
	...
	return withUlwLoopMutationLock(repoRoot, scope, async () => {
		...
		const goalJson =
			runtime === "grok"
				? args.grokGoalJson ?? args.codexGoalJson
				: args.codexGoalJson ?? args.grokGoalJson;
		...
		if (!reconciliation.ok) {
			ulwLoopError(
				formatPlatformGoalReconciliation(runtime, reconciliation) || reconciliation.errors.join(" "),

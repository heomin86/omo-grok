---
name: ulw-plan
description: "MUST USE for planning before coding (Grok: /ulw-plan or /plan). Explore-first Prometheus consultant — writes decision-complete plans under .omo/plans/. Triggers: ulw-plan, /ulw-plan, plan this, make a plan, plan before coding, interview me, break this down, start planning, plan mode."
metadata:

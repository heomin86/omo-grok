---
name: start-work
description: "Execute a Prometheus work plan in Grok Build with Boulder state (.omo/boulder.json), parallel spawn_subagent workers, and Stop-hook continuation. Triggers: /start-work, start work, execute plan, continue plan, resume plan, run .omo/plans plan."
---
